...
public class FileMain {
	...
	public static void main(String[] args)throws Exception{
		...
		File newDir4=new File("C:\\2022-11-JAVA-DEVELOPER\\newDir4");
		
		System.out.println(">>newDir1디렉토리 존재여부:"+newDir1.exists());
		System.out.println(">>newDir2디렉토리 존재여부:"+newDir2.exists());
		System.out.println(">>newDir3디렉토리 존재여부:"+newDir3.exists());
		System.out.println(">>newDir4디렉토리 존재여부:"+newDir4.exists());
		...
		System.out.println("newFile2삭제여부:"+newFile2.delete());
		System.out.println("newFile3삭제여부:"+newFile3.delete());
