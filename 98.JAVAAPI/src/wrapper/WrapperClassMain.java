...
public class WrapperClassMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("*************AYTO BOXING,자동형변환*****************");
		...
		for (int i = 0; i < scoreArray.length; i++) {
			/*
			Integer temps =(Integer)scoreArray[i];
			int score = temps.intValue();
		...
		System.out.println(wi11==wi22);//Wapper객체 서로비교하지말것
