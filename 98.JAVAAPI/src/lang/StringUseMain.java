...
public class StringUseMain {
	...
	public static void main(String[] args) {
		...
		String str2 = "오늘은 금요일String 클래스를 공부해요.";
		...
		System.out.println("Have a nice day!!!!!".substring(7,11));//앞은포함 뒤는 포함안됨
		System.out.println("오늘은 금요일String 클래스를 공부해요.".substring(4,7));
		System.out.println("오늘은 금요일String 클래스를 공부해요.".substring(4));
		
		System.out.println("---------------------charAt---------------------");
		String userId = "testST#00%??dmf";
		char firstChar = userId.charAt(0);
		System.out.println(">>아이디첫글자는 영문대(소)문자여야한다.");
		if((firstChar>='a'&&firstChar<='z')||(firstChar>='A'&&firstChar<='Z')) {
			
			System.out.println(firstChar+":유효");
		}else {
			System.out.println(firstChar+"는 노유효");
		}
