	...
	public StudentServiceArrayListFrameMain() {
		...
		findByNoStudentBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Student student=studentService.findByStudent(no);
				if(student!=null) {
					student.print();
				}else {
		...
		findByGradeStudentsBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String name1 =gradeTF.getText();
				char name2 =name1.charAt(0);
				ArrayList<Student> std = studentService.findByGrade(name2);
